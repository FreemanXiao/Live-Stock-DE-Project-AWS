...
## Data Pipeline with ELT Execution 🛤️🛤️
 1. We utilize AWS Lambda to fetch data from the Alpha Vantage API and stream it into AWS Firehose. This process is handled by: [lambda_API_function]([https://github.com/FreemanXiao/Live-Stock-DE-Project-AWS/Lambda_function/lambda_ingest_100_day_info.py]
